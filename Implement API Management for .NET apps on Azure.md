---
lab:
    Title: 'Lab: Create a multi-tier solution by using Azure services for .NET apps'
    Module: 'Learning Path: Implement API Management'
---

# Lab: Create a multi-tier solution by using Azure services for .NET apps
