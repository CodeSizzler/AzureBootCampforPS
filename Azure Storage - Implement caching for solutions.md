---
lab:
    Title: 'Lab: Enhance a web application by using the Azure Content Delivery Network'
    Module: 'Azure Storage: Implement caching for solutions'
---

# Lab: Enhance a web application by using the Azure Content Delivery Network
